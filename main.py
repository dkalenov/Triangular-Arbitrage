...
if __name__ == "__main__":
    ...
    while True:
        ...
        for t_pair in structured_pairs:
            surface_rate = func_triangular_arb.calc_triangular_arb_surface_rate(t_pair, min_rate=1.5) # min_rate - min percentage profit we get
        ...
        if len(surface_rates_list) > 0:
            with open("uniswap_surface_rates.json", "w") as fp:
                ...
                print(f'File saved ({datetime.now().strftime("%d-%m-%Y %H:%M:%S")})')
